...
from fact_clip.configs.utils import get_cfg_defaults
from fact_clip.utils.dataset import create_dataset, DataLoader
from fact_clip.utils import utils
from fact_clip.utils.evaluate import Checkpoint, Video
...
for dataset_name, n_splits in [
    ...
    cfg.merge_from_file(f'./fact_clip/configs/{dataset_name}.yaml')
    ...
    for split in range(1, n_splits+1):
        ...
        if dataset_name == 'epic-kitchens':
            from fact_clip.models.blocks_SepVerbNoun import FACT
